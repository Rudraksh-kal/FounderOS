function LogoutModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-md px-4 sm:px-6">
      <div className="relative w-full max-w-md rounded-2xl sm:rounded-3xl border border-[#242424] bg-[#0f0f0f] p-5 sm:p-8 shadow-[0_0_80px_rgba(124,58,237,0.2)]">
        ...
        <div className="relative z-10 text-center">
          <div className="mx-auto mb-6 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-red-500/20 text-red-400 text-xl sm:text-2xl font-bold">
            !
          </div>
