    ...
    >
      ...
      >
        ...
        <p className="text-[#b3b3b3] mt-6 max-w-2xl mx-auto leading-7">
          FounderOS combines AI tools, analytics, automation, and
          collaboration into one modern platform.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
        {features.map((feature, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#111] border border-[#2a2a2a] rounded-3xl p-8 hover:border-violet-500 hover:-translate-y-2 transition-all duration-300"
          >
            <div className="w-16 h-16 rounded-2xl bg-violet-600/20 text-violet-400 flex items-center justify-center mb-7">
              {feature.icon}
            </div>
            ...
            <p className="text-[#b3b3b3] leading-7">
              {feature.desc}
            </p>
          </motion.div>
        ))}
