  ...
  function Workspace() {
    ...
    const sendMessage = () => {
      ...
      addMessage(
        chatId,
        "ai",
        "FounderOS AI integration coming soon..."
      );
            ...
            <div className="px-6 pb-6">
              <div className="max-w-4xl mx-auto">
                <div className="bg-[#111] border border-[#222] rounded-3xl p-3 flex items-center gap-3">
                  ...
                  <button
                    onClick={sendMessage}
                    className="bg-violet-600 hover:bg-violet-500 transition-all duration-300 p-3 rounded-2xl"
                  >
                    <Send size={18} />
                  </button>
                </div>
